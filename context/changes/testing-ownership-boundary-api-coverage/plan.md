...
- [x] 2.1 `context/foundation/test-plan.md` §6.1 no longer says `TBD` — 2303f2d
- [x] 2.2 `context/foundation/test-plan.md` §6.1 names the backend ownership/API test location, reference tests, assertion pattern, and run command — 2303f2d
- [x] 2.3 `context/foundation/test-plan.md` §6.6 includes a concise Phase 1 note — 2303f2d
- [x] 2.4 Backend tests still pass with Java 22 after the documentation update — 2303f2d

#### Manual

- [x] 2.5 Review §6.1 and confirm it reads like a reusable project cookbook entry, not a one-off implementation log — 2303f2d
